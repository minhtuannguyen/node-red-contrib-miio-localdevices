...
class MIIOdevtypesVocabulary {
    ...
    static heatfan_list() {
        return {
            ...
            8: {name:'Xiaomi Kettle (v20)', model: "xiaomi.kettle.v20", protocol: "miot", addDef: true},
            9: {name:'Mi Smart Air Fryer (maf07)', model: "careli.fryer.maf07", protocol: "miot", addDef: true},
        };
    };
