    ...
    static command_list(model) {
        switch (model) {
            ...
            case "careli.fryer.maf07":
                return {
                    "TargetTemperature": { label: "℃ Target Temperature"},
                    "TargetTime": { label: "🕐 Target Time (minutes)"},
                    "AppointTime": { label: "🕐 Appointment Time (minutes)"},
                    "FoodQuanty": { label: "⚙ Food Quanty"},
                    "PreheatSwitch": { label: "⚙ Preheat Switch"},
                    "TurnPot": { label: "⚙ Turn Pot"},
                    "StartCook": { label: "► Start Cook"},
                    "Pause": { label: "❙❙ Pause"},
                    "CancelCooking": { label: "◼ Cancel Cooking"},
                    "StartCustomCook": { label: "► Start Custom Cook"},
                    "ResumeCooking": { label: "► Resume Cooking"},
                };
