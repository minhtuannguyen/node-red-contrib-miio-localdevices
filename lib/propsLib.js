...
class MIIOpropsVocabulary {
    static properties_list(model) {
        switch (model) {
            ...
            case "careli.fryer.maf07":
                return {
                    'air-fryer:status': "Status",
                    'air-fryer:fault': "Fault",
                    'air-fryer:target-time': "Target_Time",
                    'air-fryer:target-temperature': "Target_Temperature",
                    'air-fryer:left-time': "Left_Time",
                    'custom:recipe-id': "Recipe_Id",
                    'custom:appoint-time': "Appoint_Time",
                    'custom:appoint-time-left': "Appoint_Time_Left",
                    'custom:food-quanty': "Food_Quanty",
                    'custom:preheat-switch': "Preheat_Switch",
                    'custom:turn-pot': "Turn_Pot",
                };
            ...
            case "xiaomi.kettle.v20":
                return {
                    'kettle:on': "Power",
                    'kettle:status': "Status",
                    'kettle:temperature': "Current_Temp",
                    'kettle:target-temperature': "Target_Temp",
                    'kettle:auto-keep-warm': "Auto_Keep_Warm",
                    'kettle:keep-warm-temperature': "Keep_Warm_Temp",
                    'function:warming-time': "Warming_Time",
                    'function:keep-warm-time': "Keep_Warm_Time",
                    'function:target-mode': "Target_Mode",
                    'function:kettle-lifting': "Kettle_Lifting",
                    'no-disturb:no-disturb': "No_Disturb",
                    'function:custom-knob-temp': "Custom_Knob_Temp",
                    'function:lift-remember-temp': "Lift_Remember_Temp",
                    'function:boiling-reminder': "Boiling_Reminder",
                    'function:keep-warm-reminder': "Keep_Warm_Reminder",
                };
